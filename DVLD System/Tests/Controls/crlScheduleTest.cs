...
using static DVLD_System.Tests.Controls.ctrlScheduleTest;
    ...
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                _TestAppointment = new clsTestAppointment(); //Instance
            }
            else
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //---------------------------------------------------------------------------------------------------
            if (dtpTestDate.Value.Date > clsTestAppointment.GetLastTestAppointment(_LocalDrivingLicenseApplicationID, _TestTypeID).AppointmentDate.Date
            ...
            {
                MessageBox.Show("You cannt schedule test\nbefore or in the same\ndate of the last test date!!", "Error",MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            //---------------------------------------------------------------------------------------------------
            ...
            // Cheke if creation mode is: "Retake Test".
            if (_CreationMode == enCreationMode.RetakeTestSchedule)
                _TestAppointment.PaidFees = float.Parse(lblTotalFees.Text);
            else
                _TestAppointment.PaidFees = float.Parse(lblFees.Text);
