...
namespace DVLD_System.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenseInfoWithFilter : UserControl
    {
        ...
        public void LoadLicenseInfo(int LicenseID)
        {
            ...
            if (OnLicenseSelected != null && FilterEnabled) //Note: OnLicenseSelected != null ===> This means: Someone's waiting for me on this Event.
        ...
        {
            //Allow only numbers to be entered and not letters.
