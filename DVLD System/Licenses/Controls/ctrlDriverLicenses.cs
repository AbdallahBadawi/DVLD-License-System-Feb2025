    ...
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            if (dgvLocalLicensesHistory.Rows.Count > 0)
            {
                ...
                dgvLocalLicensesHistory.Columns[2].Width = 265;
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no driver linked with PersonID = " + PersonID, "Error", MessageBoxButtons.OK);
                return;
            }
        ...
        private void showLicenseInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            DVLD_System.Licenses.Local_Licenses.frmShowLicenseInfo frm = new DVLD_System.Licenses.Local_Licenses.frmShowLicenseInfo(LicenseID);
            frm.ShowDialog();
        }
