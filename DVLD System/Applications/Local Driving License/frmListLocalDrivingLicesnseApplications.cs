...
namespace DVLD_System.Applications.Local_Driving_License
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void sechduleSteetTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void cmsApplications_Opening(object sender, CancelEventArgs e)
        {
            ...
            //Enabled only if person passed all tests and Does NOT have a license. 
            ...
            if (sechduleTestsToolStripMenuItem.Enabled)
            {
                ...
                sechduleVisonTestToolStripMenuItem.Enabled = !PassedVisionTest;
                ...
                sechduleSteetTestToolStripMenuItem.Enabled = PassedVisionTest && PassedWrittenTest && !PassedStreetTest;
            }
