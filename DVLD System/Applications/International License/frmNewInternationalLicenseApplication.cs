    ...
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            if (ActiveInternaionalLicenseID != -1)
            {
                ...
                lblApplicationID.Text = clsInternationalLicense.Find(_InternationalLicenseID).ApplicationID.ToString();
                return;
            }
        ...
        private void llShowLicenseHistory_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            //Refresh, because there is a possibility the user edit the peron's info
            ctrlDriverLicenseInfoWithFilter1.LoadLicenseInfo(int.Parse(lblLocalLicenseID.Text));
        }
